...
# TODO items are items I might consider setting.
...
# - [sebastienrousseau/maccfg: A guide to getting your MacBook Pro M1 ready for Software Development.](https://github.com/sebastienrousseau/maccfg/tree/main)
...
# TODO change these to my preferences
...
printf "%s\n" "Killall: Restart Finder and Dock (though many changes need a restart/relog)."
killall Finder
killall Dock
