...
# ---- 
# OLD ITEMS TO REMOVE BELOW HERE
...
# keroku tools - as of 2018 we no longer use heroku
# brew install heroku

# dev tools added recently
...
# non-brew stuff to install
echo "## non-brew stuff to install.."
# very useful postgres tools for heroku - as of 2018 no longer use Keroku
