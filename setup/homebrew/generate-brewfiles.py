...
Brewfile.homeserver, Brewfile.desktop, Brewfile.work, Brewfile.ai,
Brewfile.games) are all hand-maintained and never touched by this generator.
"""
...
def main():
    ...
    print(f"note: Brewfile and the persona files (Brewfile.minimum, Brewfile.homeserver, Brewfile.desktop, Brewfile.work, Brewfile.ai, Brewfile.games) are hand-curated and left untouched.")
